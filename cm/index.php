...
<html lang="en">
  ...
  <body>
    ...
    <a href="index.php"> <img src="image/logo.png" /></a>
     ...
     <div class="login">
    <a href="../logout.php"><img src="image/login.png"  /></a>
    </div>
    <div class="username">
    ...
    <div id="main_navigation" class="dark_navigation"> <!-- Main navigation start -->
        <div class="inner_navigation" >
            ...
            <ul class="main" >
                <li ><a class="expand"  href="list.php"><i class="icon-home"></i>&nbsp;&nbsp;门店管理</a>
...
<!--                </li>-->
    ...
    <div id="content" class="no-sidebar">
     <!-- Content start -->
            ...
            <iframe  class="inner_navigation1" name="right" src="list.php" frameborder="0" width="100%" scrolling="auto" height="100%"></iframe>
